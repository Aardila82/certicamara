...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/pdf-confirmation', [LogCotejoIndividualController::class, 'generarPDF'])->name('pdf.confirmation');
    Route::get('/reconocimiento-facial', [LogCotejoIndividualController::class, 'reconocimientoFacial'])->name('reconocimiento.facial');
