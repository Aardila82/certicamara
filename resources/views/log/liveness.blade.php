...
<div class="container-fluid mt-5" >
    ...
    <div class="row">
          ...
          <table id="dataTable" class="table table-striped table-bordered shadow-lg" style="width: 100%">
              <thead class="bg-primary text-white">
                  <tr>
                      ...
                      <th>NUT</th>
                      <th>NUIP</th>
                      <th>ID de liveness</th>

                      <th>Fecha Proceso Liveness</th>
                      <th>Clase de liveness</th>
                      <th>Resultado deteccion liveness</th>
        ...
        <div class="col-4">
            <a href="{{ url('log/liveness-export') }}" class="btn btn-primary text-right mb-3">Exportar a TXT</a>
        </div>
    </div>
</div>
<!-- Pop-up de Editar -->
